...
export { default as FidGroupLogo } from './fid-group.vue'
export { default as AmkodorInvar } from './amkodor-invar.vue'
export { default as AkronPao } from './akron-pao.vue'
export { default as Ummc } from './ummc.vue'